...
function YogaAccountSubscriptions({t, match, history}) {
                ...
                <Card.Body>
                  <Grid.Row>
                    ...
                    <Grid.Col xs={12} md={12}>
                      <Link to={`/yoga/account/subscriptions/${node.id}/credits`}>
                        <Button
                          block
                          outline
                          color="info"
...
export default withTranslation()(withRouter(YogaAccountSubscriptions))