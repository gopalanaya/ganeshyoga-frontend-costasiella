...
function YogaAccountClasses({t, match, history}) {
          ...
          fetchMore({
            ...
            updateQuery: (previousResult, {fetchMoreResult }) => {
              ...
              return newEdges.length
                ? {
                  //  Put the new subscriptions at te end of the list and update `pageInfo`
...
export default withTranslation()(withRouter(YogaAccountClasses))